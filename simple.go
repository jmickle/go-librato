...
func (m *SimpleMetrics) GetCounter(name string) chan float64 {
...
func (m *SimpleMetrics) GetCustomCounter(name string) chan map[string]float64 {
...
func (m *SimpleMetrics) NewCounter(name string) chan float64 {
...
func (m *SimpleMetrics) NewCustomCounter(name string) chan map[string]float64 {
